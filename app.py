...
def init_db():
    ...
    # Таблица товаров (без photo, добавим позже ALTER TABLE)
    ...
    # Таблица списаний (без доп. полей, добавим позже)
